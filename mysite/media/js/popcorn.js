...
function loop() {
	...
	if(count>=waitTime && listCount<popArr.length){
		...
		var elem = '<a data-link="'+popArr[i][1]+'" data-weight="'+popArr[i][2]+'" data-name="'+popArr[i][0]+'" class="keyword_item"><div id="'+keyword+'" class="popcorn" style="left:'+x+'px;"><h3>'+popArr[i][0]+'</h3></div></a>';
